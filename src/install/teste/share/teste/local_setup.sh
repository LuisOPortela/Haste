...
: ${AMENT_CURRENT_PREFIX:="/home/vboxuser/Haste/src/install/teste"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/teste/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/teste/environment/path.sh"
